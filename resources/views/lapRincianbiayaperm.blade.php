...
<body>
    <div class="container">
        ...
        <table style="width: 700px; margin-left: 5px;">
            ...
            <tr>
                <td style="text-align: center;" colspan=>Notaris dan PPAT</td>
                <td style="text-align: center;" colspan=>Bendahara</td>
                <td style="text-align: center;" colspan=>Petugas</td>
            </tr>
            <tr>
                {{-- <td style="padding-top: 40px;" colspan="2">&nbsp;</td> --}}
                <td></td>
                <td style="text-align:center;vertical-align: middle; padding: 2px;" align="center">
                    <div style="margin-top:5px;">Status : {{ $rincianbiayaperm['status_rincianbiayaperm'] }}</div>
                    <div style="margin-top:5px;">Nomor : {{ $rincianbiayaperm['id'] }}</div>
                </td>
                <td></td>
            </tr>
            <tr>
