...
<body>
    ...
    <table class="detail-isi-lap">
        ...
        <tbody>
            @forelse ($biayaperms as $biayaperm)
                <tr>
                    <td>{{ $biayaperm['no_daftar'] }}</td>
                    <td>{{ $biayaperm['tgl_biayaperm'] }}</td>
                    <td>{{ $biayaperm['nama_jenispermohonan'] }}</td>
                    <td>{{ $biayaperm['permohonan'] }}</td>
                    <td>{{ $biayaperm['users'] }}</td>
                    <td align='right'>{{ $biayaperm['jumlah_biayaperm'] }}</td>
                    <td align='right'>{{ $biayaperm['jumlah_bayar'] }}</td>
                    <td align='right'>{{ $biayaperm['kurang_bayar'] }}</td>
                </tr>
            @empty
                <tr>
