        ...
        <table style="width: 700px; margin-left: 5px;">
            ...
            <tr>
                ...
                <td style="text-align:center;vertical-align: middle; padding: 2px;" align="center">
                    <div style="margin-top:5px;">Status : {{ $keluarbiayapermuser['status_keluarbiayapermuser'] }}
                    </div>
                    <div style="margin-top:5px;">Nomor : {{ $keluarbiayapermuser['id'] }}</div>
                </td>
                <td></td>
            </tr>
            <tr>
                ...
                <td style="text-align: center;">{{ strtoupper($keluarbiayapermuser['user']['name']) }}</td>
            </tr>
        </table>
    </div>
</body>
