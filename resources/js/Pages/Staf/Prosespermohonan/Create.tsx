...
import CardTableProsespermohonans from "@/Components/Cards/Staf/CardTableProsespermohonans";
...
const Create = () => {
    ...
    const setPermohonan = (permohonan: Permohonan | undefined) => {
        ...
        // router.get(route('staf.prosespermohonans.create', { transpermohonan_id: permohonan.transpermohonan.id }), {}, { preserveState: true, preserveScroll: true })
    };
