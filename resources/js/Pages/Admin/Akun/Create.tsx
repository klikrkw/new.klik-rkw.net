...
const Create = () => {
    ...
    const { kelompokakuns } = usePage<{ kelompokakuns: OptionSelect[] }>().props;
                    ...
                    <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg shadow-slate-400 rounded-lg bg-blueGray-200 border-0">
                        ...
                        <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                            <form onSubmit={handleSubmit}>
                                ...
                                {/* <Input name='slug' label='Slug' errors={errors.slug} value={data.slug} type='slug' onChange={e => setData('slug', e.target.value)} /> */}
                                <SelectSearch name='kelompokakuns' options={kelompokakuns}
