...
const Edit = () => {
    ...
    const { itemprosesperm } = usePage<any>().props;
                    ...
                    <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-200 border-0">
                        ...
                        <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                            <form onSubmit={handleSubmit}>
                                <Input name='nama_itemprosesperm' label='Nama Jenis Permohonan' errors={errors.nama_itemprosesperm} value={data.nama_itemprosesperm} onChange={e => setData('nama_itemprosesperm', e.target.value)} />
