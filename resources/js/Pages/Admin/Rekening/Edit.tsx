...
import { Rekening, OptionSelect } from "@/types";
...
const Edit = () => {
    ...
    const { rekening, akunOpts, selAkunOpt } = usePage<{
        rekening: Rekening;
        selGruprekeningOpts: OptionSelect[];
    ...
    const { data, setData, errors, post, processing } = useForm<FormValues>({
        ...
        ket_rekening: rekening.ket_rekening || "",
    ...
    function handleSubmit(e: any) {
        e.preventDefault();
        post(route("admin.rekenings.update", rekening.id));
    }
