                        ...
                        <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="relative w-full mb-5">
                                    ...
                                    <Select name='roles' options={roles} isMulti onChange={onChange} className='shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150' />
                                </div>
