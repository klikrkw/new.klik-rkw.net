...
import { Tempatarsip, Tempatberkas } from "@/types";
...
export default function CardTableTempatberkas({
    color = "light",
    tempatberkas,
    className = "",
    meta,
    ...
    const handleRemoveData = (id: string) => {
        router.delete(route(baseRoute + "tempatberkas.destroy", id));
    };
            ...
            >
                <div className="rounded-t mb-0 px-4 py-3 border-0">
                    <div className="flex justify-between">
                        ...
                        <div className="flex justify-center gap-2 flex-row items-start">
                            ...
                            <LinkButton
                                theme="blue"
                                href={route(baseRoute + "tempatberkas.create")}
                            >
                                <span>Tambah</span>
                ...
                <div className="block w-full overflow-x-auto">
                    <table className="items-center w-full bg-transparent border-collapse">
                        ...
                        <tbody>
                            {tempatberkas.map(
                                ({ id, nama_tempatberkas, ruang }, index) => (
                                    <tr key={index}>
