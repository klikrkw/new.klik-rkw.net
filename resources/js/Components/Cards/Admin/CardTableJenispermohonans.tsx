...
export default function CardTableJenispermohonans({
    color = "light",
    jenispermohonans,
    className = "",
    meta,
            ...
            >
                ...
                <div className="block w-full overflow-x-auto">
                    <table className="items-center w-full bg-transparent border-collapse">
                        ...
                        <tbody>
                            {jenispermohonans.map(
                                ({ id, nama_jenispermohonan }, index) => (
                                    <tr key={index}>
