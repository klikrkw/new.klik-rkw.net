...
import { CompleteIcon, EditActiveIcon } from "@/Components/Icon";
                    ...
                    <VerticalTimeline key={p.id}>
                        {p.statusprosesperms &&
                            p.statusprosesperms.map((e, idx) => (
                                ...
                                >
                                    <div className="w-full flex flex-col p-2 text-sm bg-white/20 shadow-md rounded-md">
                                        <h3 className="vertical-timeline-element-title text-sm font-bold text-yellow-300 ">
                                            {
                                                p.itemprosesperm
                                                    .nama_itemprosesperm
                                            }
