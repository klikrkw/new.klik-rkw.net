...
// components
export default function CardTableRekenings({
    color = "light",
    rekenings,
    className = "",
    meta,
    ...
    const handleRemoveData = (id: string) => {
        router.delete(route("admin.rekenings.destroy", id));
    };
                ...
                <div className="rounded-full mb-0 px-4 py-3 border-0 ">
                    <div className="flex justify-between w-full flex-col md:flex-row">
                        ...
                        <div className="flex justify-center gap-2 flex-row items-start">
                            ...
                            <LinkButton
                                theme="blue"
                                href={route("admin.rekenings.create")}
                            >
                ...
                <div className="block w-full overflow-x-auto">
                    <table className="items-center w-full bg-transparent border-collapse">
                        ...
                        <tbody>
                            {rekenings.map(
                                (
                                    { id, nama_rekening, ket_rekening, akun },
                                    index
                                ) => (
                                    <tr key={index}>
