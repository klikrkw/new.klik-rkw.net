...
// components
export default function CardTableItemkegiatans({
    color = "light",
    itemkegiatans,
    className = "",
    meta,
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-2">
                                            <ul className="list-none flex gap-2">
                                                {grupitemkegiatans &&
                                                    grupitemkegiatans.map(
                                                        (item, i) => (
                                                            <li
                                                                className="rounded-full text-xs py-1 px-2 bg-lightBlue-800 text-lightBlue-200 border-lightBlue-700"
                                                                key={item.id}
                                                            >
                                                                {
                                                                    item.nama_grupitemkegiatan
                                                                }
                                                            </li>
                                                        )
                                                    )}
                                        ...
                                        <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-lg whitespace-nowrap p-2">
                                            {is_alert ? (
