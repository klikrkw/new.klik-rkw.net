...
export default function CardTableRuangs({
    color = "light",
    ruangs,
    className = "",
    meta,
    ...
    const handleRemoveData = (id: string) => {
        router.delete(route(baseRoute + "ruangs.destroy", id));
    };
                ...
                <div className="rounded-t mb-0 px-4 py-3 border-0">
                    <div className="flex justify-between">
                        ...
                        <div className="flex justify-center gap-2 flex-row items-start">
                            ...
                            <LinkButton
                                theme="blue"
                                href={route(baseRoute + "ruangs.create")}
                            >
                                <span>Tambah</span>
                ...
                <div className="block w-full overflow-x-auto">
                    <table className="items-center w-full bg-transparent border-collapse">
                        ...
                        <tbody>
                            {ruangs.map(
                                (
                                    { id, nama_ruang, kode_ruang, kantor },
                                    index
                                ) => (
                                    <tr key={index}>
