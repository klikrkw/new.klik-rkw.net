                    ...
                    data.map((item, index: number) => {
                        if (
                            item.itemrincianbiayaperm
                                .jenis_itemrincianbiayaperm === "pemasukan"
                        ) {
                            return (
                                <li
                                    key={item.id}
            ...
            <ul className="list-none container-snap max-h-80 overflow-x-hidden rounded-b-md shadow-md">
                {data &&
                    data.map((item, index: number) => {
                        if (
                            item.itemrincianbiayaperm
                                .jenis_itemrincianbiayaperm === "pengeluaran"
                        ) {
                            return (
                                <li
                                    key={item.id}
            ...
            <ul className="list-none container-snap max-h-80 overflow-x-hidden rounded-b-md shadow-md">
                {data &&
                    data.map((item, index: number) => {
                        if (
                            item.itemrincianbiayaperm
                                .jenis_itemrincianbiayaperm === "piutang"
                        ) {
                            return (
                                <li
                                    key={item.id}
...
export default CardDrincianbiayapermList;
