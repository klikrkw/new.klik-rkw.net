...
import { Itemprosesperm, Itemrincianbiayaperm } from "@/types";
import { twMerge } from "tailwind-merge";
import { Link, router } from "@inertiajs/react";
import { usePrevious } from "react-use";
import { min, pickBy } from "lodash";
...
export default function CardTableItemrincianbiayaperms({
    color = "light",
    ...
    const handleRemoveData = (id: number) => {
        router.delete(route("admin.itemrincianbiayaperms.destroy", id));
    };
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="flex justify-center gap-2 flex-row items-start">
                            ...
                            <LinkButton
                                theme="blue"
                                href={route(
                                    "admin.itemrincianbiayaperms.create"
                                )}
                            >
                                <span>Tambah</span>
                            </LinkButton>
                            ...
                            <tr>
                                ...
                                >
                                    <Link
                                        ...
                                        onClick={(e) =>
                                            handleSortLinkClick({
                                                sortBy: "nama_itemrincianbiayaperm",
                                                sortDir:
                                                    values.sortDir === "asc"
                                                        ? "desc"
                                                        : "asc",
                                    ...
                                    >
                                        <div className="flex flex-row justify-between">
                                            <span>Nama Item Rincian Biaya</span>
                                            <IconSort
                                                sortBy="nama_itemrincianbiayaperm"
                                                sortDir={values.sortDir || ""}
                                            />
                                ...
                                >
                                    <Link
                                        ...
                                        onClick={(e) =>
                                            handleSortLinkClick({
                                                sortBy: "jenis_itemrincianbiayaperm",
                                                sortDir:
                                                    values.sortDir === "asc"
                                                        ? "desc"
                                                        : "asc",
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-2 ">
                                            <div className="flex justify-start gap-1 ">
                                                <Link
                                                    href={route(
                                                        "admin.itemrincianbiayaperms.edit",
                                                        id
                                                    )}
