...
export default function CardTableTempatarsips({
    color = "light",
    tempatarsips,
    className = "",
    meta,
    ...
    const handleRemoveData = (id: string) => {
        router.delete(route(baseRoute + "tempatarsips.destroy", id));
    };
                ...
                <div className="rounded-t mb-0 px-4 py-3 border-0">
                    <div className="flex justify-between">
                        ...
                        <div className="flex justify-center gap-2 flex-row items-start">
                            ...
                            <LinkButton
                                theme="blue"
                                href={route(baseRoute + "tempatarsips.create")}
                            >
                                <span>Tambah</span>
