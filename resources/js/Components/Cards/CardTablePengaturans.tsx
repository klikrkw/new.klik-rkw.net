...
export default function CardTablePengaturans({
    color = "light",
    pengaturans,
    className = "",
    meta,
    ...
    const handleRemoveData = (id: number) => {
        router.delete(route("admin.pengaturans.destroy", id));
    };
                ...
                <div className="rounded-t mb-0 px-4 py-3 border-0">
                    <div className="flex justify-between">
                        ...
                        <div className="flex justify-center gap-2 flex-row items-start">
                            ...
                            <LinkButton
                                theme="blue"
                                href={route("admin.pengaturans.create")}
                            >
                                <span>New</span>
                            </LinkButton>
                        </div>
