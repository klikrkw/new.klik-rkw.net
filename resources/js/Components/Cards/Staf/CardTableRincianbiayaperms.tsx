...
export default function CardTableRincianbiayaperms({
    ...
    const { isAdmin, user, base_route, curstatus, statusOpts } = usePage<{
        isAdmin: boolean;
        user: OptionSelect;
        base_route: string;
    ...
    const handleRemoveData = (id: string) => {
        router.delete(route("staf.transaksi.rincianbiayaperms.destroy", id));
    };
                ...
                <div className="flex justify-between w-full flex-col md:flex-row">
                    ...
                    <div className="flex justify-center gap-2 flex-row items-start w-full md:w-1/2">
                        ...
                        <LinkButton
                            theme="blue"
                            href={route(
                                "staf.transaksi.rincianbiayaperms.create"
                            )}
                        >
                                ...
                                <tr key={index}>
                                    ...
                                    <td className="border-t-0 px-2 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap py-4">
                                        <MenuDropdown>
                                            <Link
                                                href={route(
                                                    "staf.transaksi.rincianbiayaperms.edit",
                                                    id
                                                )}
                                                className={
