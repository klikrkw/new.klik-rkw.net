...
type Props = {
    ...
    statusprosesperms: OptionSelect[];
...
function CardTableProsespermohonans({
    ...
    const handleRemoveData = (prosespermohonan_id: string, id: string) => {
        router.delete(
            route(
                "staf.transaksi.prosespermohonans.statusprosesperms.destroy",
            ...
            <ul className="list-none container-snap max-h-80 overflow-x-hidden rounded-b-md shadow-md">
                {prosespermohonans &&
                    prosespermohonans.map(
                        (prosespermohonan: Prosespermohonan, index: number) => (
                            <li
                                key={prosespermohonan.id}
                            ...
                            >
                                <div className="flex w-full text-sm px-2 py-0 items-center justify-start gap-1 font-semibold text-lightBlue-600 border-t-2 border-lightBlue-400">
                                    ...
                                    <div className="w-[40%] md:w-[25%]">
                                        {
                                            prosespermohonan.itemprosesperm
                                                .nama_itemprosesperm
                                        }
                                    </div>
                                ...
                                0 ? (
                                    <div className="w-full flex flex-col text-sm border-t-2 border-lightBlue-400">
                                        <div className="list-none w-full px-6 bg-lightBlue-100  text-lightBlue-700">
                                            {prosespermohonan.statusprosesperms.map(
                                                (
                                                    statusprosesperm: StatusprosespermProsespermohonan,
                                                    index: number
                                                ) => {
