...
class RincianbiayapermStafController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Staf/Rincianbiayaperm/Index', [
            'filters' => Request::all(),
    ...
    public function create()
    {
        ...
        if($permohonan_id){
            ...
            if($permohonan){
                $recp = $permohonan->where('id',$permohonan_id)->whereHas('users', fn($q) => $q->where('id','=',$this->user->id))->first();
    ...
    public function store(Request $request)
    {
        ...
        return to_route('staf.transaksi.rincianbiayaperms.edit', $rincianbiayaperm->id)->with('success', 'Rincianbiayaperm created.');
    }
    ...
    public function edit(Rincianbiayaperm $rincianbiayaperm)
    {
        ...
        return Inertia::render('Staf/Rincianbiayaperm/Edit', [
    ...
    public function update(Request $request, Rincianbiayaperm $rincianbiayaperm)
    {
        ...
        $rincianbiayaperm->update(['total_pemasukan'=>$total_pemasukan, 'total_pengeluaran'=>$total_pengeluaran,'total_piutang'=>$total_piutang, 'sisa_saldo'=>$sisa_saldo]);
         return to_route('staf.transaksi.rincianbiayaperms.edit',$rincianbiayaperm->id)->with('success', 'Rincianbiayaperm Added');
    }
