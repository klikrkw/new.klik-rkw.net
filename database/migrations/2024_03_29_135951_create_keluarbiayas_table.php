...
return new class extends Migration
{
    ...
    {
        Schema::create('keluarbiayas', function (Blueprint $table) {
            ...
            $table->enum('status_keluarbiaya', ['wait_approval', 'approved', 'cancelled', 'rejected' => 'rejected'])->default('wait_approval');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('keluarbiayas');
    }
};
